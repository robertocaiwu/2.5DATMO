...
class Kitti_util(Kitti):
    ...
    def __velo_2_cam_projection(self, points):
        """ convert velodyne coordinates to camera image coordinates """
    ...
    def velo_points(self, h_fov=None, v_fov=None, x_range=None, y_range=None, z_range=None):
        ...
        xyz_v, c_ = self.__point_matrix(velo_gen)
        return xyz_v, c_
    ...
    def velo_2_cam_projection_frame(self, h_fov=None, v_fov=None, x_range=None, y_range=None, z_range=None):
        """ Transform velodyne 3D points to camera """
        ...
        if cam_gen is None:
            raise ValueError("Cam data is not included in this class")
        res, c_ = self.__velo_2_cam_projection(velo_gen)
